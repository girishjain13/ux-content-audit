...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BeawlAJU.mjs");
...
var manifest = {
	"01e4c63addda9e2caab6a080ee7374bfaf35cfb14c278adb0584f7166af769e7": {
		functionName: "listAuditsFn_createServerFn_handler",
		importer: () => import("./server-BXawGYlS.mjs").then((n) => n.t)
	},
	"20282c8a1ac1e164cf7041bbcae5c578018368e97989e8a82a9649103383880a": {
		functionName: "startAuditFn_createServerFn_handler",
		importer: () => import("./server-BXawGYlS.mjs").then((n) => n.t)
	},
	"b8de9a7f445dea5e45df254efdcdd327c0dccf307f215055fcd84f0e05617a06": {
		functionName: "getAuditFn_createServerFn_handler",
		importer: () => import("./server-BXawGYlS.mjs").then((n) => n.t)
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-a3g9-sn2.mjs").then((n) => n.t),
